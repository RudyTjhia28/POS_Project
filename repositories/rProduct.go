...
func (r *ProductRepository) CreateProduct(request models.CreateProductRequest) (models.Product, error) {
...
func (r *ProductRepository) UpdateProduct(request models.CreateProductRequest) (models.Product, error) {
